...
initial begin
	assign xgmii_vif.crc_state 			= dut.rx_eq0.curr_state;
	assign xgmii_vif.crc_calculated 	= dut.rx_eq0.crc_rx;
	
	assign xgmii_vif.crc_rx_state 		= dut.rx_eq0.crc_bytes;
	assign xgmii_vif.crc_rx_value 		= dut.rx_eq0.crc32_d64;
	
	assign pos_l3_vif.crc_rx_state 		= dut.tx_dq0.shift_crc_eop;
	assign pos_l3_vif.crc_rx_value 		= dut.tx_dq0.crc32_d64;
end
...
initial begin
  ...
  initial begin
	...
	run_test ("pos_l3_ethernet_test_random");
